 ...
 * @author Petar
 */
public class SOUpdateConfirmation extends AbstractSO {
    ...
    protected void validate(AbstractDomainObject ado) throws Exception {
        ...
        for (Confirmation potvrda : potvrde) {
            System.out.println(confirmation.getConfirmationID() + " | " + potvrda.getConfirmationID());
            if (!confirmation.getConfirmationID().equals(potvrda.getConfirmationID()) && confirmation.getCar().getRegNumber().equals(potvrda.getCar().getRegNumber())
