 ...
 * @author Petar
 */
public class PregledCenovnikaForm extends javax.swing.JDialog {
     ...
     */
    public PregledCenovnikaForm(DodajPotvrduForm parent, boolean modal, PriceListItem stavkaCenovnika) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        OdabirStavkeForm forma = new OdabirStavkeForm(this, true, cenovnik);
    ...
    private void popuniTabelu() {
        try {
            ...
            Logger.getLogger(PregledCenovnikaForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    void setPriceListItem(PriceListItem stavka) {
        ...
        DodajPotvrduForm forma = (DodajPotvrduForm) getParent();
