 ...
 * @author Petar
 */
public class DodajPotvrduForm extends javax.swing.JDialog {
     ...
     */
    public DodajPotvrduForm(PotvrdeForm parent, boolean modal, User ulogovani1) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Dodavanje potvrde o rentu");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PregledCenovnikaForm forma = new PregledCenovnikaForm(this, true, stavkaCenovnika);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            Confirmation potvrda = new Confirmation(-1l, dateFrom, dateTo, rentPrice, stavkaCenovnika.getCategory(), car, client, stavkaCenovnika, ulogovani);
            try {
                ClientController.getInstance().addConfirmation(potvrda);
                JOptionPane.showMessageDialog(this, "Uspesno napravljena potvrda!");
                this.dispose();
